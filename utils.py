...
if __name__ == '__main__':
    processed_json_path = 'LLM_Few_shot/output/GMNER/GMNER_qwen-vl-max-latest_20250511_base_fewshot_result.json'
    ground_truth_path = 'annotations/twitter_gmner_gt.json'
    output_path = 'LLM_Few_shot/output/GMNER/GMNER_qwen-vl-max-latest_20250511_base_fewshot_result-rerank.json'
